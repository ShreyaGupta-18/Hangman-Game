...
public class ReadWords {
    ...
    private static final String SRC_COM_GAME_WORD_TXT = "C:\\Users\\kshitiz gupta\\Desktop\\JAVA\\JavaProject\\src\\Game\\words.txt";
        ...
        while(true){
            ...
            if(isGuessingCorrect){
                ...
                if(numberOfChances == 0){
                    System.out.println("Sorry you ran out of the chances.");
    ...
    private List<String> getTheWords() throws FileNotFoundException {
        ...
        File wordsFile = new File(SRC_COM_GAME_WORD_TXT);
